...
def get_data():
    ...
    print(train_data_old.shape,val_data_old.shape,test_data_old.shape)
    ...
    print(train_data_new.shape, val_data_new.shape,test_data_new.shape)
    ...
    labels = []
    labels.extend([0]*len(train_data_old))
    labels.extend([0]*len(val_data_old))
    labels.extend([1]*len(train_data_new))
    labels.extend([1]*len(val_data_new))
    ...
    labels = []
    labels.extend([0]*len(test_data_old))
    labels.extend([1]*len(test_data_new))
...
if __name__=="__main__":
    ...
    parser.add_argument("--base", default="davidson")
    parser.add_argument("--new", default="HOPN")
